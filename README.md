...
This is a way of changing Windows 10 taskbar opacity/make taskbar transparent without 3rd party software. This way you don't need to add more processes running on Windows.
#### Registry path:
